...
function TermCondition() {
    return (
        <>
          <div className='my-5 mx-8 sm:mx-14 md:mx-20 lg:mx-24 2xl:mx-28 3xl:mx-32'>
        <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-center mb-6'>Privacy Policy</h1>
    
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>General information</h1>
        ...
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>Right to access, correct and delete data and to object to data processing</h1>
        ...
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>Management of personal data</h1>
        <p className='text-base sm:text-lg mb-6'>
        ...
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>Information we collect</h1>
        <p className='text-base sm:text-lg mb-6'>
        ...
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>How we use your information</h1>
        <p className='text-base sm:text-lg mb-6'>
        ...
        <h1 className='font-bold text-xl sm:text-2xl md:text-3xl mb-4'>Sharing your information</h1>

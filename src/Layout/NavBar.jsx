...
import { Navigate, useNavigate } from 'react-router-dom'
        ...
        return (
            <div className='bg-white'>
                ...
                <div className=''>
                    {/* top nav bar  */}
                    <div className='flex justify-between px-5 pt-7 items-center overflow-clip pb-4'>
                        {/*left side */}
                    ...
                    <div className='lg:flex hidden mt-4 w-full justify-center items-center  '>
                        <ul className='flex space-x-5 font-bold text-[16px] '>
                            <li onClick={()=>{navigate('/')}} className='hover:border-b-2 border-black pb-2 cursor-pointer'>HOME</li>
                            <li className='hover:border-b-2 border-black pb-2 cursor-pointer'>CATALOG</li>
                            <li onClick={()=>{navigate('/collection')}}  className=' delay-800  cursor-pointer '><span className='hover:border-b-2 border-black pb-2'>COLLECTIONS</span></li>
                            <li onClick={()=>{navigate('/section-all')}} className='hover:border-b-2 border-black pb-2 cursor-pointer'>SECTIONS ALL</li>
